...
public class SchedulingTasksForFixedRateRepeatedExecutionsUsingExecutors {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ScheduledFuture<?> scheduledFuture1 = scheduledExecutorService.scheduleAtFixedRate(new ScheduleTaskB(1000),
				4, 2, TimeUnit.SECONDS);
		ScheduledFuture<?> scheduledFuture2 = scheduledExecutorService.scheduleAtFixedRate(new ScheduleTaskB(1000),
				4, 2, TimeUnit.SECONDS);
