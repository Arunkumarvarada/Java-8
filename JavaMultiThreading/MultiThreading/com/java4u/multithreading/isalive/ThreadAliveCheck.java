package com.java4u.multithreading.isalive;
...
public class ThreadAliveCheck {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		while(true) {
			...
			System.out.println("[" + currentThreadName + "] AFTER STARTING Is: " + t1.getName() + " alive =" + t1IsAlive);
			System.out.println("[" + currentThreadName + "] AFTER STARTING Is: " + t2.getName() + " alive =" + t2IsAlive);
