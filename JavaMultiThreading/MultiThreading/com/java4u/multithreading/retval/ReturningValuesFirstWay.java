...
import com.java4u.multithreading.util.ValueReturningTaskA;
...
public class ReturningValuesFirstWay {
	...
	public static void main(String[] args) {
		...
		ValueReturningTaskA task2 = new ValueReturningTaskA(5, 4, 1000);
		Thread t2 = new Thread(task2, "Thread-2");

		ValueReturningTaskA task3 = new ValueReturningTaskA(6, 5, 500);
